...
import Stock_Lists from "../../Components/Modal/Stock Lists";
...
return (
    <div className="flex w-full h-full  overflow-hidden px-8">
        ...
        <div className="w-full h-full bg-white text-black text-left dark:bg-black font-semibold text-28  ">
          ...
          <span className="text-black dark:text-white text-left font-semibold px-2 text-28">
          STOCK LISTS JOB HISTORY
          </span>
