...
import Heat_Fives from '../../Components/Modal/Heat Fives';
import BaseModal from '../../Components/Modal/BaseModal';
export default function HeatFives() {
...
StateName={open}
 ...
 />
        ...
        <div className="w-full h-full bg-white text-black dark:bg-black  text-left font-semibold text-28  ">
            
            <div className="flex flex-col ">
          <span className="text-black dark:text-white text-left font-semibold text-28 px-2">
          Heat FIVES JOB HISTORY
          </span>
...
/>    
                <div className='px-6'>
                <ButtonComp text={`Configure Scheduler`}  
                        BtnClass={`h-8 w-32`}
