...
import Premium_Lists from "../../Components/Modal/Premium Lists";
export default function PremiumLists() {
...
const hanldeSearch = () =>{
  ...
  return (
    <div className="flex w-full h-full  overflow-hidden px-8">
      {premiumOpen && (
        <BaseModal>
          <Premium_Lists StateName={premiumOpen} setStated={setPremiumOpen} header={highLight} />
        </BaseModal>
      )}
      <div className="w-full h-full bg-white text-black text-left dark:bg-black font-semibold text-28  ">
        <div className="flex flex-col ">
          <span className="text-black text-left font-semibold text-28 dark:text-white px-2">
            PREMIUM LISTS JOB HISTORY
          </span>
